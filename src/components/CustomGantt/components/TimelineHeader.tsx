...
import { eachDayOfInterval, format, isSameMonth, endOfMonth, differenceInDays, startOfMonth, addDays } from 'date-fns';
import { ko } from 'date-fns/locale';

export function TimelineHeader() {
    const { startDate, endDate, columnWidth, viewMode } = useGanttStore();
