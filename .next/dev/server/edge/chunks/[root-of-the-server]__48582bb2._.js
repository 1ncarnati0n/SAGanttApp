...
async function updateSession(request) {
    ...
    if (!user && !request.nextUrl.pathname.startsWith("/auth/login") && !request.nextUrl.pathname.startsWith("/auth/signup") && !request.nextUrl.pathname.startsWith("/auth/callback") && request.nextUrl.pathname !== "/") {
